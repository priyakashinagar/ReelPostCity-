...
function Footer() {
  return (
    <footer className="w-full bg-gray-950 text-gray-300 border-t border-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-white font-semibold text-lg mb-4">CityReels</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button className="hover:text-blue-400 transition-colors cursor-pointer bg-none border-none p-0 text-left">Explore</button></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button className="hover:text-blue-400 transition-colors cursor-pointer bg-none border-none p-0 text-left">Contact</button></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm">&copy; 2026 CityReels. All rights reserved.</p>
