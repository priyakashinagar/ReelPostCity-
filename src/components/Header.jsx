    ...
    <header className="bg-black/70 backdrop-blur-md border-b border-gray-800/50 sticky top-0 z-50 shadow-lg shadow-black/20 navbar-bottom-shine text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          >
            <div className="w-10 h-10 bg-linear-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center shadow-xl relative overflow-hidden blue-shine-border">
              <span className="text-xl text-white z-10">🌍</span>
              {/* Animated blue shine */}
              <span className="absolute inset-0 rounded-lg pointer-events-none animate-shine bg-linear-to-br from-blue-300/40 via-blue-400/60 to-blue-600/40 blur-sm opacity-80" />
            </div>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="w-9 h-9 bg-linear-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs shadow-md shadow-blue-400/50 hover:shadow-lg hover:shadow-blue-400/70 transition-shadow"
                  title="Go to profile"
                >
