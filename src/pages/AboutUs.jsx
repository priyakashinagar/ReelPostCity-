    ...
    <div className="w-full min-h-screen bg-gray-900">
      ...
      <section className="relative bg-cover bg-center py-16 px-4 sm:px-6 lg:px-8" style={{backgroundImage: 'url(https://picsum.photos/1200/400?random=104)'}}>
        ...
        <div className="relative max-w-7xl mx-auto">
          <h1 className="text-5xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-4">About Us</h1>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-8">Our Vision</h2>
      ...
      {/* Teams Sections */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-gray-900 to-gray-900">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent text-center mb-14">Meet Our Team</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-8">Explore Our World</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent text-center mb-14">Our Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
