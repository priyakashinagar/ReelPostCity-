    ...
    <div className="w-full min-h-screen bg-gray-900">
      ...
      <section className="relative bg-cover bg-center py-12 px-4 sm:px-6 lg:px-8" style={{backgroundImage: 'url(https://picsum.photos/1200/400?random=103)'}}>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-4xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-4">Contact Us</h1>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              {/* Support Details */}
              <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 shadow-lg shadow-blue-400/20">
                <h2 className="text-2xl font-bold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent mb-6">Support Details</h2>
