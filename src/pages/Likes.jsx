...
function Likes({ onNavigate }) {
  const [likedPosts, setLikedPosts] = useState([
    { id: 1, type: 'image', city: 'Lucknow', title: 'Golden hour at the canals', author: 'Sarah Wilson', image: 'https://picsum.photos/400/300?random=101', date: '2 hours ago', likes: 1234 },
    { id: 2, type: 'image', city: 'Pune', title: 'Street art in the Red Light District', author: 'Sarah Wilson', image: 'https://picsum.photos/400/300?random=102', date: '3 hours ago', likes: 845 },
    { id: 3, type: 'image', city: 'Lakhimpur Kheri', title: 'Cherry blossoms at Ueno Park', author: 'Marcus Chen', image: 'https://picsum.photos/400/300?random=106', date: '8 hours ago', likes: 5123 },
    { id: 4, type: 'image', city: 'Noida', title: 'Sunrise at Tanah Lot Temple', author: 'Lisa Wong', image: 'https://picsum.photos/400/300?random=108', date: '11 hours ago', likes: 5876 },
    { id: 5, type: 'image', city: 'Delhi', title: 'Times Square at midnight', author: 'David Park', image: 'https://picsum.photos/400/300?random=110', date: '14 hours ago', likes: 6789 },
  ]);
  ...
  return (
    ...
    <div className="w-full bg-gray-900 flex flex-col lg:flex-row">
      ...
      {/* CENTER CONTENT */}
      <section className="w-full lg:flex-1 lg:ml-64 lg:mr-80 py-8 px-4 pb-20 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 blue-shine-border rounded-2xl">
            ...
            {likedPosts.map((post) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-600 gap-2">
                    <span className="text-xs text-gray-500">{post.date}</span>
                    <div className="flex gap-2">
                      <button 
                        onClick={() => onNavigate('posts')}
                        className="px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-full transition-all">
                        View
                      </button>
                      <button 
                        onClick={() => handleUnlike(post.id)}
                        className="px-3 py-1 bg-red-600 hover:bg-red-500 text-white text-xs font-semibold rounded-full transition-all">
                        Unlike
                      </button>
                    </div>
                  </div>
